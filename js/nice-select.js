  ...
  $.fn.niceSelect = function(method) {
    ...
    function create_nice_select($select) {
      ...
      if( $selectedHtml ){
        ...
        $dropdown.find('.list').prepend($('<div class="title_select">'+$selectedHtml+'</div>'))
      } else {
        $dropdown.find('.current').html($selected.data('display') || $selected.text());

        $dropdown.find('.list').prepend($('<div class="title_select"></div>'))

        $dropdown.find('.list .title_select').html($selected.data('display') || $selected.text())
      }

      $dropdown.find('.list').prepend($('<button type="button" class="close_select"></button>'))
